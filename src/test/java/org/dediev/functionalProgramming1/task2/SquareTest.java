...
class SquareTest {
    ...
    private Square test = new Square();
    ...
    public void squareTest1() {
        ...
        Collections.addAll(result, 1, 4, 9);
        Assertions.assertEquals(result, test.square(integers));
    }
    ...
    public void squareTest2() {
        ...
        Collections.addAll(result, 36, 64, 36, 64, 1);
        Assertions.assertEquals(result, test.square(integers));
    }
